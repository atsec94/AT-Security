...
Immediately after agent deployment, documented the following baseline state before any hardening or attack simulation.

---

## Baseline Findings (DC01) — March 25, 2026
...
Primary vulnerable package: `Microsoft Windows Server 2022 Standard Evaluation 10.0.20348.587` (1,448 findings). Unpatched evaluation build — baseline intentionally captured before patching to document before/after delta.

![DC01 Vulnerability Overview](screenshots/WazuhVulnOverview.png)
...
### MITRE ATT&CK — Top Tactics (First 24 Hours)
| Tactic | Alert Count |
|---|---|
| Defense Evasion | 71 |
| Persistence | 71 |
...
| `WazuhVulnOverview.png` | Vulnerability overview across all agents |
